(function (_, Kotlin, $module$kotlin_wrappers_kotlin_css, $module$kotlin_extensions, $module$inline_style_prefixer, $module$kotlin_react, $module$kotlin_react_dom, $module$styled_components, $module$react, $module$react_dom, $module$kotlinx_html_js) {
  'use strict';
  var $$importsForInline$$ = _.$$importsForInline$$ || (_.$$importsForInline$$ = {});
  var get_s = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.get_s_rcaex3$;
  var Timing = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.Timing;
  var get_times = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.get_times_s8ev3n$;
  var AnimationDirection = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.AnimationDirection;
  var FillMode = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.FillMode;
  var PlayState = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.PlayState;
  var animation = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.animation_hb31zf$;
  var KeyframesBuilder = $module$kotlin_wrappers_kotlin_css.kotlinx.css.properties.KeyframesBuilder;
  ...
  var StyledElement = $module$kotlin_wrappers_kotlin_css.kotlinx.css.StyledElement;
  ...
  var CSSBuilder = $module$kotlin_wrappers_kotlin_css.kotlinx.css.CSSBuilder;
  ...
  var default_0 = $module$styled_components.default;
  ...
  var keyframes = defineInlineFunction('kotlin-styled.styled.keyframes_sizrkg$', wrapFunction(function () {
    var KeyframesBuilder_init = _.$$importsForInline$$['kotlin-wrappers-kotlin-css'].kotlinx.css.properties.KeyframesBuilder;
    var invoke = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_dgimx$;
    var invoke_0 = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_9p99ed$;
  ...
  var forwardCss = defineInlineFunction('kotlin-styled.styled.forwardCss_ln282g$', function ($receiver, builder) {
    var tmp$;
  ...
  var keyframesName = defineInlineFunction('kotlin-styled.styled.keyframesName_61zpoe$', wrapFunction(function () {
    var invoke = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_dgimx$;
    var invoke_0 = _.$$importsForInline$$['kotlin-extensions'].kotlinext.js.invoke_9p99ed$;
    var injectGlobal = _.styled.injectGlobal_61zpoe$;
  ...
  Styled.prototype.wrap_0 = function (type) {
    ...
    if (value == null) {
      var answer = invoke_0(default_0(type), [Styled$wrap$lambda$lambda]);
  ...
  $$importsForInline$$['kotlin-wrappers-kotlin-css'] = $module$kotlin_wrappers_kotlin_css;
  ...
  return _;
}(module.exports, require('kotlin'), require('kotlin-wrappers-kotlin-css'), require('kotlin-extensions'), require('inline-style-prefixer'), require('kotlin-react'), require('kotlin-react-dom'), require('styled-components'), require('react'), require('react-dom'), require('kotlinx-html-js')));
