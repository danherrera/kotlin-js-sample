(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-css'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlin-wrappers-kotlin-css'.");
    }root['kotlin-wrappers-kotlin-css'] = factory(typeof this['kotlin-wrappers-kotlin-css'] === 'undefined' ? {} : this['kotlin-wrappers-kotlin-css'], kotlin);
  }
  ...
  RuleContainer.prototype.buildRules_s47sd7$ = function ($receiver, indent) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      $receiver.append_61zpoe$(element_0.key + ' {' + '\n');
    ...
    while (tmp$_1.hasNext()) {
      ...
      $receiver.append_61zpoe$(selector_0 + ' {' + '\n');
  ...
  CSSBuilder.prototype.toString = function () {
    ...
    while (tmp$.hasNext()) {
      var element = tmp$.next();
      $receiver.append_61zpoe$(hyphenize(element.key) + ': ' + element.value.toString() + ';' + '\n');
    }
  ...
  BoxShadow.prototype.toString = function () {
    var $receiver = StringBuilder_init();
    if (this.inset_0)
      $receiver.append_61zpoe$('inset ');
    $receiver.append_61zpoe$(this.offsetX_0.toString() + ' ' + this.offsetY_0 + ' ' + this.blurRadius_0 + ' ' + this.spreadRadius_0 + ' ' + this.color);
    return $receiver.toString();
  };
  BoxShadow.$metadata$ = {
    kind: Kind_CLASS,
  ...
  TextDecoration.prototype.toString = function () {
    if (this.lines_0.isEmpty())
      ...
      var $receiver = StringBuilder_init();
      var tmp$, tmp$_0;
      $receiver.append_61zpoe$(joinToString_0(this.lines_0, ' '));
      if ((tmp$ = this.style) != null) {
        $receiver.append_61zpoe$(' ' + tmp$);
      }if ((tmp$_0 = this.color) != null) {
        $receiver.append_61zpoe$(' ' + tmp$_0);
      }return $receiver.toString();
    }
  };
  ...
  Kotlin.defineModule('kotlin-wrappers-kotlin-css', _);
  return _;
}));

//# sourceMappingURL=kotlin-wrappers-kotlin-css.js.map
